...
export function CatalogPageHero({
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex w-full flex-1 flex-col items-center justify-end gap-1.5 px-0 pb-10 pt-2 text-center sm:gap-2 sm:pb-11">
        <div className="nl-page w-full">
          <h1 className="font-display text-[clamp(1.35rem,1.05rem+1.1vw,2.15rem)] font-semibold leading-[1.15] tracking-tight text-white [text-shadow:0_2px_18px_rgba(0,0,0,0.45)]">
            {title}
          </h1>
