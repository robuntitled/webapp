  ...
  return (
    <div className="flex items-center gap-2 overflow-x-auto pb-1 scrollbar-none">
      <button
        ...
        className={`plan-v2-day-pill plan-v2-day-pill-row shrink-0 ${
          selection === 'overview' ? 'plan-v2-day-pill-active' : ''
        }`}
      >
          ...
          return (
            ...
            >
              <button
                ...
                aria-pressed={active}
                className={`plan-v2-day-pill ${active ? 'plan-v2-day-pill-active' : ''}`}
              >
              ...
              {canRemove && (
                <button
                  ...
                  className="absolute -right-1.5 -top-1.5 flex h-5 w-5 items-center justify-center rounded-full bg-rose-500 text-white opacity-0 shadow-sm transition-opacity group-hover:opacity-100 focus:opacity-100"
                >
                  <X className="h-3 w-3" />
                </button>
              )}
      ...
      <button
        ...
        className="plan-v2-day-add shrink-0"
      >
